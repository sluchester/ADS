...
def main(port="/dev/ttyUSB1", baud=9600, dst64="0013A20040B9701C", msg="Alo mundo"):
    dev = ZigBeeDevice(port, baud)
    try:
        dev.open()
        remote = RemoteZigBeeDevice(dev, XBee64BitAddress.from_hex_string(dst64))
        dev.send_data(remote, msg)  # a lib monta 0x10/0x11 conforme AO
...
if __name__ == "__main__":
    ...
    ap.add_argument("--dst64", required=True, help="Ex.: 0013A20040B9701C")
